...
const currentEmployee = {
  ...
  phone: "555-000-1111",
  vehicleId: "VAN-007",
  avatarUrl: "https://placehold.co/150x150.png?text=JS"
};
...
export default function EmployeeProfilePage() {
  ...
  const onSubmit: SubmitHandler<ProfileFormInputs> = async (data) => {
    ...
    console.log("Employee Profile update data:", data);
    toast({
  ...
  return (
    <div className="space-y-6">
       <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold text-primary">My Employee Profile</h1>
      </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="relative">
              <Avatar className="w-24 h-24 border-2 border-primary">
                <AvatarImage src={currentEmployee.avatarUrl} alt={currentEmployee.name} data-ai-hint="person portrait"/>
                <AvatarFallback>{currentEmployee.name.substring(0, 2).toUpperCase()}</AvatarFallback>
              </Avatar>
            ...
            <div>
              ...
              <CardDescription>Manage your personal and work-related information.</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input id="email" type="email" {...register("email")} className="mt-1" readOnly/>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
               ...
               <div>
                <Label htmlFor="vehicleId">Assigned Vehicle ID (Optional)</Label>
                <Input id="vehicleId" {...register("vehicleId")} className="mt-1" />
